...
SECRET_KEY = '8852Dca2A63F2Dfaf193594E13C6293A5D191Ad9E18B2151'
...
DATABASES = {
        'default': {
            ...
            'NAME': 'dd7jm1v4mvb742',
            'USER': 'ltutpjyojmsmee',
            'PASSWORD': '76e53bdfbc5463100ed218e6660772150b4ebdbcab36372f13957325935ff16c',
            'HOST': 'ec2-44-208-88-195.compute-1.amazonaws.com',
            'PORT': '5432',
            'URL': 'postgres://ltutpjyojmsmee:76e53bdfbc5463100ed218e6660772150b4ebdbcab36372f13957325935ff16c@ec2-44-208-88-195.compute-1.amazonaws.com:5432/dd7jm1v4mvb742',
            'HEROKU CLI': 'heroku pg:psql postgresql-dimensional-99107 --app family-associatior-a',
        }
}
